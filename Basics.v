...
Proof.
  intros f.
  intros H.
  destruct b as [|b']; rewrite -> H; rewrite -> H; reflexivity.
Qed.
...
Lemma demorgan_1 : forall n m : bool, andb (negb n) (negb m) = negb (orb n m).
Proof.
  intros n m.
  destruct n as [|n'].
...
Lemma bor_true_l : forall a, orb true a = true.
Proof.
  intros a.
  reflexivity.
Qed.

Lemma band_true_l : forall a, andb true a = true -> a = true.
Proof.
  intros a.
  simpl.
  intros H.
